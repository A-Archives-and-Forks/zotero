...
advanced-search-condition-input =
    .aria-label = 值
    .label = { $label }
search-conditions-tooltip-fields = 欄位：
...
search-conditions-note = 筆記
search-conditions-childNote = 子筆記
search-conditions-creator = 創作者
search-conditions-thesisType = 學位論文類
search-conditions-reportType = 報告類
search-conditions-videoRecordingFormat = 影音格式
search-conditions-audioFileType = 音訊檔案類
search-conditions-audioRecordingFormat = 音訊格式
search-conditions-letterType = 信件類
search-conditions-interviewMedium = 訪談媒介類
search-conditions-manuscriptType = 手稿類
search-conditions-presentationType = 簡報類
search-conditions-mapType = 地圖類
search-conditions-artworkMedium = 藝術作品媒介類
search-conditions-dateModified = 修改日期
search-conditions-fulltextContent = 附件內容
search-conditions-programmingLanguage = 程式語言
search-conditions-fileTypeID = 附件檔案類型
search-conditions-lastRead = Attachment Last Read
search-conditions-annotationText = 標註文字
search-conditions-annotationComment = 標註評論
search-conditions-anyField = 任何欄位
