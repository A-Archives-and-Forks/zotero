...
general-more-information = Frekari upplýsingar
...
advanced-search-condition-input =
    .aria-label = Value
    .label = { $label }
search-conditions-tooltip-fields = Svæði:
search-conditions-collection = Safn
search-conditions-savedSearch = Vistaðar leitir
search-conditions-itemTypeID = Tegund færslu
search-conditions-tag = Merki
search-conditions-note = Athugasemd
search-conditions-childNote = Undirathugasemd
search-conditions-creator = Höfundur
search-conditions-thesisType = Tegund ritgerðar
search-conditions-reportType = Tegund skýrslu
search-conditions-videoRecordingFormat = Snið kvikmyndar
search-conditions-audioFileType = Tegund hljóðskrár
search-conditions-audioRecordingFormat = Snið hljóðupptöku
search-conditions-letterType = Tegund bréfs
search-conditions-interviewMedium = Viðtalsmiðill
search-conditions-manuscriptType = Tegund handrits
search-conditions-presentationType = Tegund kynningar
search-conditions-mapType = Tegund korts
search-conditions-artworkMedium = Miðill listaverks
search-conditions-dateModified = Dagsetning breytingar
search-conditions-fulltextContent = Innihald viðhengis
search-conditions-programmingLanguage = Forritunarmál
search-conditions-fileTypeID = Tegund viðhengisskráar
