...
general-show-in-library = Erakutsi liburutegian
...
general-back = Atzera
general-edit = Editatu
general-cut = Moztu
general-copy = Kopiatu
general-paste = Itsatsi
general-find = Aurkitu
general-delete = Ezabatu
general-insert = Txertatu
general-and = eta
general-et-al = et al.
general-previous = Aurrekoa
general-next = Hurrengoa
general-learn-more = Gehiago jakin
general-more-information = Informazio gehiago
...
attachment-info-title = Izenburua
...
note-info-date-modified = Noiz aldatua
note-info-size = Tamaina
note-info-word-count = Word Count
note-info-character-count = Character Count
item-title-empty-note = Izengabeko oharra
...
advanced-search-condition-input =
    .aria-label = Value
    .label = { $label }
search-conditions-tooltip-fields = Eremuak:
search-conditions-collection = Bilduma
search-conditions-savedSearch = Gordetako bilaketa
search-conditions-itemTypeID = Elementu mota
search-conditions-tag = Etiketa
search-conditions-note = Oharra
search-conditions-childNote = Ohar umea
search-conditions-creator = Sortzailea
search-conditions-thesisType = Tesi Mota
search-conditions-reportType = Txosten mota
search-conditions-videoRecordingFormat = Bideo grabaketaren formatua
search-conditions-audioFileType = Audio fitxategi mota
search-conditions-audioRecordingFormat = Audio grabaketaren formatua
search-conditions-letterType = Gutun Mota
search-conditions-interviewMedium = Elkarrizketa komunikabidea
search-conditions-manuscriptType = Eskuizkribu mota
search-conditions-presentationType = Aurkezpen mota
search-conditions-mapType = Mapa mota
search-conditions-artworkMedium = Arte-lan Medio
search-conditions-dateModified = Aldatutako data
search-conditions-fulltextContent = Eranskinen edukia
search-conditions-programmingLanguage = Hizkuntza
search-conditions-fileTypeID = Eranskin fitxategi mota
search-conditions-lastRead = Attachment Last Read
search-conditions-annotationText = Oharpenaren testua
search-conditions-annotationComment = Oharpenaren iruzkina
search-conditions-anyField = Edozein eremu
