...
general-more-information = 정보 더 보기
general-warning = 경고
...
advanced-search-condition-input =
    .aria-label = Value
    .label = { $label }
search-conditions-tooltip-fields = 필드:
search-conditions-collection = 컬렉션
search-conditions-savedSearch = 저장된 검색
search-conditions-itemTypeID = 항목 종류
search-conditions-tag = 태그
search-conditions-note = 노트
search-conditions-childNote = 하위 노트
search-conditions-creator = 창작가
search-conditions-thesisType = 논문 형식
search-conditions-reportType = 보고서 형식
search-conditions-videoRecordingFormat = 동영상 녹화 형식
search-conditions-audioFileType = 사운드 파일 형식
search-conditions-audioRecordingFormat = 오디오 녹음 형식
search-conditions-letterType = 편지 형식
search-conditions-interviewMedium = 회견 매체
search-conditions-manuscriptType = 원고 형식
search-conditions-presentationType = 발표 형식
search-conditions-mapType = 지도 형식
search-conditions-artworkMedium = 삽화 매체
search-conditions-dateModified = 변경일
search-conditions-fulltextContent = 목차 첨부
search-conditions-programmingLanguage = 프로그래밍 언어
search-conditions-fileTypeID = 첨부 파일 형식
search-conditions-lastRead = Attachment Last Read
search-conditions-annotationText = 주석 텍스트
search-conditions-annotationComment = 주석 댓글
search-conditions-anyField = 임의 필드
