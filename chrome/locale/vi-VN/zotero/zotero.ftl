...
general-cancel = Hủy
general-show-in-library = Hiển thị trong Thư viện
...
note-info-date-modified = Ngày Thay đổi
note-info-size = Size
note-info-word-count = Word Count
note-info-character-count = Character Count
item-title-empty-note = Ghi chép Vô danh
...
advanced-search-condition-input =
    .aria-label = Value
    .label = { $label }
search-conditions-tooltip-fields = Trường:
...
search-conditions-note = Ghi chép
search-conditions-childNote = Ghi chép con
search-conditions-creator = Người tạo lập
search-conditions-thesisType = Kiểu Luận văn
search-conditions-reportType = Kiểu Phóng sự/Báo cáo
search-conditions-videoRecordingFormat = Video Recording Format
search-conditions-audioFileType = Kiểu Tập tin Ghi âm
search-conditions-audioRecordingFormat = Audio Recording Format
search-conditions-letterType = Kiểu Thư
search-conditions-interviewMedium = Phương tiện Phỏng vấn
search-conditions-manuscriptType = Kiểu Bản thảo
search-conditions-presentationType = Kiểu Trình bày
search-conditions-mapType = Kiểu Bản đồ
search-conditions-artworkMedium = Chất liệu
search-conditions-dateModified = Ngày thay đổi
search-conditions-fulltextContent = Nội dung Phần đính kèm
search-conditions-programmingLanguage = Ngôn ngữ lập trình
search-conditions-fileTypeID = Kiểu của Tập tin Đính kèm
