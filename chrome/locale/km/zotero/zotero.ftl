...
general-show-in-library = បង្ហាញនៅក្នុងបណ្ណាល័យ
general-restartApp = Restart { -app-name }
general-restartInTroubleshootingMode = Restart in Troubleshooting Mode
general-save = Save
general-clear = សម្អាត
general-update = Update
general-back = Back
general-edit = កែតម្រូវ
general-cut = កាត់
general-copy = ថតចម្លង
general-paste = បិទភ្ជាប់
general-find = ស្វែងរក
general-delete = លុបចោល
...
general-more-information = ព័ត៌មានបន្ថែម
...
menu-density =
    .label = Density
add-attachment = បន្ថែមឯកសារកម្ជាប់
...
menu-add-child-linked-file-attachment =
    .label = ភ្ជាប់កម្ជាប់ទៅនឹងឯកសារ...
menu-add-child-linked-url-attachment =
    .label = Attach Web Link…
menu-new-note =
    .label = { new-note }
menu-new-standalone-note =
    .label = កំណត់ត្រាទោលថ្មី
menu-new-item-note =
    .label = New Item Note
menu-restoreToLibrary =
    .label = ស្តារទៅកាន់បណ្ណាល័យវិញ
...
import-online-intro-title = សេចក្តីផ្តើម
import-source-file =
...
general-error = កំហុស
file-interface-import-error = មានកំហុសបានកើតឡើងខណៈពេលដែលព្យាយាមនាំចូលឯកសារដែលបានជ្រើសរើស។ សូមបញ្ជាក់ថា លុះត្រាតែឯកសារមានសុពល​ភាព​ និង ព្យាយាមម្តងទៀត។
...
bibliography-outputMethod-saveAsRTF =
    .label = ទាញរក្សាទុកជាអ៊ែរធីអែហ្វ
bibliography-outputMethod-saveAsHTML =
    .label = ទាញរក្សាទុកជាអេចធីអេមអិល
bibliography-outputMethod-copyToClipboard =
    .label = ចម្លងទៅកាន់កន្លែងរក្សាទុកឯកសារបណ្តោះអាសន្ន
...
new-collection-name = ឈ្មោះ:
new-collection-create-in = Create in:
show-publications-menuitem =
    .label = Show My Publications
attachment-info-title = ចំណងជើង
attachment-info-filename = Filename
attachment-info-accessed = ចូលមើល
attachment-info-pages = ទំព័រ
attachment-info-modified = កែតម្រូវ
attachment-info-index = បានដាក់លិបិក្រម
...
note-info-date-modified = កែតម្រូវ
note-info-size = Size
note-info-word-count = Word Count
note-info-character-count = Character Count
item-title-empty-note = កំណត់ចំណាំគ្មានចំណងជើង
...
advanced-search-condition-input =
    .aria-label = Value
    .label = { $label }
search-conditions-tooltip-fields = វិស័យ:
search-conditions-collection = កម្រងឯកសារ
search-conditions-savedSearch = ការស្រាវជ្រាវទាញរក្សាទុក
search-conditions-itemTypeID = ប្រភេទឯកសារ
search-conditions-tag = ស្លាក
search-conditions-note = កំណត់ចំណាំ
search-conditions-childNote = កំណត់ត្រារណប
search-conditions-creator = អ្នកនិពន្ធ
search-conditions-thesisType = ប្រភេទនិក្ខេបបទ
search-conditions-reportType = ប្រភេទរបាយការណ៍
search-conditions-videoRecordingFormat = ប្រភេទខ្សែអាត់វីដេអូ
search-conditions-audioFileType = ប្រភទខ្សែអាត់សំឡេង
search-conditions-audioRecordingFormat = ការថតសំឡេង
search-conditions-letterType = ប្រភេទសំបុត្រ
search-conditions-interviewMedium = បទសម្ភាសន៍
search-conditions-manuscriptType = ហត្ថាអត្ថបទ
search-conditions-presentationType = ឧទ្ទេសបទ
search-conditions-mapType = ប្រភេទផែនទី
search-conditions-artworkMedium = ការផ្សព្វផ្សាយសិល្បៈ
search-conditions-dateModified = កាលបរិច្ឆេទកែតម្រូវ
search-conditions-fulltextContent = ខ្លឹមសារឯកសារភ្ជាប់
search-conditions-programmingLanguage = កម្មវិធីភាសា
search-conditions-fileTypeID = ឯកសារភ្ជាប់
