...
general-show-in-library = Покзати в бібліотеці
...
general-clear = Очистити
general-update = Update
general-back = Back
general-edit = Редагувати
general-cut = Вирізати
...
general-more-information = Додаткова інформація
...
menu-add-child-linked-file-attachment =
    .label = Прикріпити посилання на файл...
menu-add-child-linked-url-attachment =
    .label = Attach Web Link…
menu-new-note =
    .label = { new-note }
menu-new-standalone-note =
    .label = Нова окрема примітка
menu-new-item-note =
    .label = New Item Note
menu-restoreToLibrary =
    .label = Відновити в бібліотеці
menu-deletePermanently =
    .label = Видалити остаточно...
menu-tools-plugins =
    .label = Plugins
...
import-online-intro-title = Вступ
import-source-file =
...
file-interface-import-error = Виникла помилка під час імпортування вибраного файлу. Будь ласка, переконайтесь, що файл правильний та спробуйте ще раз.
...
rtfScan-wizard =
    .title = Сканування RTF
rtfScan-introPage-description = { -app-name } can automatically extract and reformat citations and insert a bibliography into RTF files. It currently supports citations in variations of the following formats:
rtfScan-introPage-description2 = Щоб почати, виберіть нижче вхідний файл RTF та вихідний файл:
rtfScan-input-file = Input File:
rtfScan-output-file = Output File:
rtfScan-no-file-selected = Файл не вибрано
...
bibliography-outputMethod-label = Метод вводу:
bibliography-outputMethod-saveAsRTF =
    .label = Зберегти як RTF
bibliography-outputMethod-saveAsHTML =
    .label = Зберегти як HTML
bibliography-outputMethod-copyToClipboard =
    .label = Скопіювати в буфер обміну
bibliography-outputMethod-print =
    .label = Роздрукувати
bibliography-manageStyles-label = Керувати стилями
...
new-collection-name = Назва:
new-collection-create-in = Create in:
show-publications-menuitem =
    .label = Show My Publications
attachment-info-title = Назва
attachment-info-filename = Ім'я файлу
attachment-info-accessed = Дата доступу
attachment-info-pages = Сторінки
attachment-info-modified = Дата зміни
attachment-info-index = Проіндексовано
...
note-info-date-modified = Дата зміни
note-info-size = Size
note-info-word-count = Word Count
note-info-character-count = Character Count
item-title-empty-note = Примітка без назви
...
search-conditions-collection = Підбірка
search-conditions-savedSearch = Збередений пошук
search-conditions-itemTypeID = Тип документа
search-conditions-tag = Тег
search-conditions-note = Примітка
search-conditions-childNote = Дочірня примітка
search-conditions-creator = Автор
search-conditions-thesisType = Тип дисертації
search-conditions-reportType = Тип звіту
search-conditions-videoRecordingFormat = Формат відео
search-conditions-audioFileType = Тип аудіо файлу
search-conditions-audioRecordingFormat = Формат аудіо
search-conditions-letterType = Тип листа
search-conditions-interviewMedium = Засіб інтерв'ю
search-conditions-manuscriptType = Тип рукопису
search-conditions-presentationType = Тип презентації
search-conditions-mapType = Тип карти
search-conditions-artworkMedium = Художній засіб
search-conditions-dateModified = Дата зміни
search-conditions-fulltextContent = Зміст вкладення
search-conditions-programmingLanguage = Мова програмування
search-conditions-fileTypeID = Тип вкладеного файлу
...
file-type-presentation = Презентація
