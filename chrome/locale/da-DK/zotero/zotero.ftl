...
general-more-information = Mere information
...
item-title-empty-note = Note uden titel
...
search-conditions-tag = Mærke
search-conditions-note = Note
search-conditions-childNote = Underordnet note
search-conditions-creator = Ophav
search-conditions-thesisType = Type (afhandl.)
search-conditions-reportType = Type (rapport)
search-conditions-videoRecordingFormat = Videoformat
search-conditions-audioFileType = Type (lydfil)
search-conditions-audioRecordingFormat = Lydformat
search-conditions-letterType = Type (brev)
search-conditions-interviewMedium = Interview-medium
search-conditions-manuscriptType = Type (manus)
search-conditions-presentationType = Type (præsent.)
search-conditions-mapType = Type (kort)
search-conditions-artworkMedium = Værkets medium
search-conditions-dateModified = Date Modified
search-conditions-fulltextContent = Indhold i Vedhæftning
search-conditions-programmingLanguage = Programmeringssprog
search-conditions-fileTypeID = Filtype (vedhæftn.)
