...
general-show-in-library = نمایش در کتابخانه
...
general-more-information = اطلاعات بیشتر
...
note-info-date-modified = تاریخ اصلاح
note-info-size = Size
note-info-word-count = Word Count
note-info-character-count = Character Count
item-title-empty-note = یادداشت بی‌عنوان
...
advanced-search-condition-input =
    .aria-label = Value
    .label = { $label }
search-conditions-tooltip-fields = فیلدها:
search-conditions-collection = مجموعه
search-conditions-savedSearch = جستجوی ذخیره شده
search-conditions-itemTypeID = نوع آیتم
search-conditions-tag = برچسب
search-conditions-note = یادداشت
search-conditions-childNote = یادداشت پیوست
search-conditions-creator = پدیدآورنده
search-conditions-thesisType = نوع پایان‌نامه
search-conditions-reportType = نوع گزارش
search-conditions-videoRecordingFormat = قالب ویدئو
search-conditions-audioFileType = نوع پرونده صوتی
search-conditions-audioRecordingFormat = قالب پرونده صوتی
search-conditions-letterType = نوع نامه
search-conditions-interviewMedium = رسانه مصاحبه
search-conditions-manuscriptType = نوع دست‌نوشته
search-conditions-presentationType = نوع ارائه
search-conditions-mapType = نوع نقشه
search-conditions-artworkMedium = رسانه اثر هنری
search-conditions-dateModified = تاریخ تغییر
search-conditions-fulltextContent = محتوای پیوست
search-conditions-programmingLanguage = زبان برنامه‌نویسی
search-conditions-fileTypeID = نوع پرونده پیوست
