...
general-cancel = Renunță
general-show-in-library = Afișează în bibliotecă
...
general-cut = Decupare
general-copy = Copiere
general-paste = Lipire
general-find = Găsește
general-delete = Ștergere
general-insert = Inserare
general-and = și
general-et-al = et al.
general-previous = Anterior
general-next = Următoarea
general-learn-more = Învață mai multe
general-more-information = Mai multe informații
...
advanced-search-condition-input =
    .aria-label = Value
    .label = { $label }
search-conditions-tooltip-fields = Câmpuri:
search-conditions-collection = Colecție
search-conditions-savedSearch = Căutare salvată
search-conditions-itemTypeID = Tip de înregistrare
search-conditions-tag = Etichetă
search-conditions-note = Notă
search-conditions-childNote = Subnotă
search-conditions-creator = Creator
search-conditions-thesisType = Tip teză
search-conditions-reportType = Tip reportaj
search-conditions-videoRecordingFormat = Format înregistrare video
search-conditions-audioFileType = Tip fișier audio
search-conditions-audioRecordingFormat = Format înregistrare audio
search-conditions-letterType = Tip scrisoare
search-conditions-interviewMedium = Tip interviu
search-conditions-manuscriptType = Tip manuscris
search-conditions-presentationType = Tip prezentare
search-conditions-mapType = Tip hartă
search-conditions-artworkMedium = Tip lucrare de artă
search-conditions-dateModified = Data modificării
search-conditions-fulltextContent = Conținut anexă
search-conditions-programmingLanguage = Limbaj de programare
search-conditions-fileTypeID = Tip fișier anexat
search-conditions-lastRead = Attachment Last Read
search-conditions-annotationText = Text adnotare
search-conditions-annotationComment = Comentariu adnotare
search-conditions-anyField = Orice câmp
