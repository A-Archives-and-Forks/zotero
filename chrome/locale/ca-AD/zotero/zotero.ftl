...
general-more-information = Més informació
...
menu-show-tabs-menu =
    .label = Mostra el menú de pestanyes
...
zotero-toolbar-tabs-scroll-forwards =
    .title = Desplaça cap endavant
zotero-toolbar-tabs-scroll-backwards =
    .title = Desplaça cap enrere
...
section-attachments-move-to-trash-message = Esteu segur que voleu moure «{ $title }» a la paperera?
section-notes =
    .label =
        { $count ->
            [one] { $count } Note
...
show-publications-menuitem =
    .label = Mostra les meves publicacions
...
note-info-date-created = Creat
note-info-date-modified = Modificat
note-info-size = Mida
note-info-word-count = Recompte de paraules
note-info-character-count = Recompte de caràcters
item-title-empty-note = Nota sense títol
attachment-preview-placeholder = Cap adjunció per previsualitzar
...
advanced-search-condition-input =
    .aria-label = Valor
    .label = { $label }
search-conditions-tooltip-fields = Camps:
search-conditions-collection = Col·lecció
search-conditions-savedSearch = Cerca desada
search-conditions-itemTypeID = Tipus d'element
...
search-conditions-thesisType = Tipus de tesi
search-conditions-reportType = Tipus d'informe
search-conditions-videoRecordingFormat = Format de gravació de vídeo
search-conditions-audioFileType = Tipus de fitxer d'àudio
search-conditions-audioRecordingFormat = Format de gravació d'àudio
search-conditions-letterType = Tipus de carta
search-conditions-interviewMedium = Mitjà de l'entrevista
search-conditions-manuscriptType = Tipus de manuscrit
search-conditions-presentationType = Tipus de presentació
search-conditions-mapType = Tipus de mapa
search-conditions-artworkMedium = Mitjà artístic
search-conditions-dateModified = Data de modificació
search-conditions-fulltextContent = Contingut de l'adjunció
search-conditions-programmingLanguage = Llengua de programació
search-conditions-fileTypeID = Tipus de fitxer de l'adjunció
search-conditions-lastRead = Attachment Last Read
search-conditions-annotationText = Text d'anotació
search-conditions-annotationComment = Comentari d'anotació
search-conditions-anyField = Qualsevol camp
