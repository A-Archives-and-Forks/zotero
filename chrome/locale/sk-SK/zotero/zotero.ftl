...
general-more-information = Viac informácií
...
advanced-search-condition-input =
    .aria-label = Value
    .label = { $label }
search-conditions-tooltip-fields = Polia:
search-conditions-collection = Kolekcia
search-conditions-savedSearch = Uložené vyhľadávanie
search-conditions-itemTypeID = Typ záznamu
search-conditions-tag = Značka
search-conditions-note = Poznámka
search-conditions-childNote = Vnorená poznámka
search-conditions-creator = Autor
search-conditions-thesisType = Druh záverečnej práce
search-conditions-reportType = Report Type
search-conditions-videoRecordingFormat = Formát videonahrávky
search-conditions-audioFileType = Typ audio súboru
search-conditions-audioRecordingFormat = Formát audionahrávky
search-conditions-letterType = Druh listu
search-conditions-interviewMedium = Komunikačné médium
search-conditions-manuscriptType = Druh rukopisu
search-conditions-presentationType = Typ prezentácie
search-conditions-mapType = Druh mapy
search-conditions-artworkMedium = Médium umeleckého diela
search-conditions-dateModified = Zmenené
search-conditions-fulltextContent = Obsah prílohy
search-conditions-programmingLanguage = Programovací jazyk
search-conditions-fileTypeID = Typ priloženého súboru
search-conditions-lastRead = Attachment Last Read
search-conditions-annotationText = Text anotácie
search-conditions-annotationComment = Komentár k anotácii
