...
general-more-information = Još informacija
...
search-conditions-savedSearch = Spremljena pretraga
search-conditions-itemTypeID = Vrsta stavke
search-conditions-tag = Oznaka
search-conditions-note = Bilješka
search-conditions-childNote = Podređena bilješka
search-conditions-creator = Stvoritelj
search-conditions-thesisType = Vrsta disertacije
search-conditions-reportType = Vrsta izvješća
search-conditions-videoRecordingFormat = Format videozapisa
search-conditions-audioFileType = Vrsta audiodatoteke
search-conditions-audioRecordingFormat = Format zvučne snimke
search-conditions-letterType = Vrsta pisma
search-conditions-interviewMedium = Medij intervjua
search-conditions-manuscriptType = Vrsta rukopisa
search-conditions-presentationType = Vrsta prezentacije
search-conditions-mapType = Vrsta karte
search-conditions-artworkMedium = Medij umjetničkog rada
search-conditions-dateModified = Datum izmjene
search-conditions-fulltextContent = Sadržaj priloga
search-conditions-programmingLanguage = Programski jezik
search-conditions-fileTypeID = Vrsta datoteke priloga
search-conditions-lastRead = Attachment Last Read
search-conditions-annotationText = Tekst anotacija
search-conditions-annotationComment = Komentar anotacija
search-conditions-anyField = Bilo koje polje
