...
general-back = Back
general-edit = Redigeer
general-cut = Cut
general-copy = Copy
general-paste = Paste
general-find = Find
general-delete = Skrap
...
attachment-info-accessed = Gebruik/Toegang verkry
...
search-conditions-dateModified = Datum gewysig
