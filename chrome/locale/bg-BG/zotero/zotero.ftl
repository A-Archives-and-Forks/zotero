...
general-more-information = Повече информация
...
advanced-search-condition-input =
    .aria-label = Value
    .label = { $label }
search-conditions-tooltip-fields = Полета:
search-conditions-collection = Колекция
search-conditions-savedSearch = Съхранено търсене
search-conditions-itemTypeID = Вид запис
search-conditions-tag = Отметка
search-conditions-note = Note
search-conditions-childNote = Дъщерна бележка
search-conditions-creator = Създател
search-conditions-thesisType = Вид дисертация
search-conditions-reportType = Вид отчет
search-conditions-videoRecordingFormat = Формат на видео запис
search-conditions-audioFileType = Вид звуков файл
search-conditions-audioRecordingFormat = Формат на аудио запис
search-conditions-letterType = Вид писмо
search-conditions-interviewMedium = Носител на интервюто.
search-conditions-manuscriptType = Вид ръкопис
search-conditions-presentationType = Вид презентация
search-conditions-mapType = Вид карта
search-conditions-artworkMedium = Носител произведението
search-conditions-dateModified = Променен на
search-conditions-fulltextContent = Съдържание на приложението
search-conditions-programmingLanguage = Програмен език
search-conditions-fileTypeID = Вид приложен файл
