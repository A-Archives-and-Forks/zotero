...
general-insert = Оруулах
general-and = ба
general-et-al = гэх мэт.
general-previous = Previous
general-next = Next
general-learn-more = Илүү ихийг мэдэж аваарай
general-more-information = Дэлгэрэнгүй мэдээлэл
general-warning = Анхааруулга
general-type-to-continue = Type “{ $text }” to continue.
general-continue = Үргэлжлүүлэх
general-red = Улаан
general-orange = Улбар шар
general-yellow = Шар
general-green = Ногоон
general-teal = Номин
general-blue = Цэнхэр
general-purple = Ягаан
general-magenta = Хүрэн улаан
general-violet = Хөх ягаан
general-maroon = Элгэн хүрэн
general-gray = Саарал
general-black = Хар
general-loading = Ачаалж байна...
...
import-file-handling = Картын сангийн удирдлага
...
import-mendeley-username = Хэрэглэгчийн нэр
import-mendeley-password = Нууц үг
general-error = Алдаа
